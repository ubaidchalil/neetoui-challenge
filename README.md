[![Build Status](https://bigbinary.semaphoreci.com/badges/neetoUI/branches/main.svg?style=shields)](https://bigbinary.semaphoreci.com/projects/neetoUI)
...
Then install the [Node.js](https://nodejs.org) version `v16.5` which we have
specified inside the `.node-version` file of this repo.
...
neetoUI is maintained by [BigBinary](https://www.BigBinary.com). BigBinary is a
